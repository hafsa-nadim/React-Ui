...
<section className="text-gray-600 body-font">
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center mt-20">
    <div className="lg:grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      <h1 className="title-font text-4xl lg:text-6xl mb-4 font-medium text-white main">Before they sold out
        <br className="hidden lg:inline-block"/>readymade <span className="text-blue-600">gluten</span>
      </h1>
      <p className="mb-8 leading-relaxed text-gray-200">Copper mug try-hard pitchfork pour-over freegan heirloom neutra <br/>air plant cold-pressed tacos poke beard tote bag. Heirloom echo park <br /> mlkshk tote bag selvage .</p>
      <div className="flex justify-center">
        <button className="inline-flex text-white bg-blue-600 border-0 py-2 px-6 focus:outline-none hover:bg-blue-800 text-sm cursor-pointer code">let's get started</button>
...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-3xl lg:text-6xl font-medium title-font mb-4 text-white">Track <span className="text-blue-600">Tour</span> Budget</h1>
